# -*- coding: utf-8 -*-
"""
Created on Thu Nov 09 13:08:05 2017
...
import pandas as pd
import Opt_DM_GUI1
import Opt_DM_Script2 as OptDM2
...
def GenNote():
    ...
    try:
        collateral, collateral_drop=OptDM2.check1(collateral)
    except:
        msbox.showinfo(title='Notice',message='在执行数据转换时,发生错误')
        return 0
    
    try:
        Notes=OptDM2.genNotes(collateral)
    except:
...
class APP_class(Opt_DM_GUI1.APP_class):
